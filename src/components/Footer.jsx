...
export default function Footer({ onSelectSection, onOpenEnquire }) {
  return (
    <footer id="footer" className="bg-stone-900 text-stone-300 border-t-4 border-[#D4AF37] pt-20 pb-12 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 pb-16 border-b border-stone-800">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-[#D4AF37] p-0.5 flex items-center justify-center">
            ...
            <div className="p-4 rounded-xl bg-stone-800/80 border border-stone-700 space-y-2">
              <div className="flex items-center gap-2 text-xs text-[#D4AF37] font-bold uppercase tracking-wider">
                <ShieldCheck className="w-4 h-4" /> RERA Registered Developer
              </div>
            ...
            <div className="flex items-center gap-3 pt-2">
              <a href="#" className="w-9 h-9 rounded-full bg-stone-800 hover:bg-[#D4AF37] hover:text-stone-900 flex items-center justify-center transition-colors">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-xs text-stone-400 font-light">
              ...
              <li>
                <button onClick={() => onSelectSection('about')} className="hover:text-[#D4AF37] transition-colors">
                  • About United Infracity
                </button>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-xs text-stone-400 font-light">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <span>+91 (0120) 4567 890 / +91 98100 12345</span>
              </div>
              <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              className="mt-2 w-full py-3 bg-[#D4AF37] hover:bg-[#B38F24] text-stone-900 font-bold text-[11px] uppercase tracking-widest rounded-xl transition-all shadow-md"
            >
