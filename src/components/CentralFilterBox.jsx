    ...
    <section className="py-8 bg-[#FDFBF7] relative z-20 border-b border-[#D4AF37]/15">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-[0_10px_35px_rgba(212,175,55,0.08)] border border-[#D4AF37]/25 relative">
          ...
          {/* Subtle Decorative Gold Accent Bars at top and bottom */}
          ...
          {/* 3 Filters in a Single Horizontal Row (One Line) */}
            ...
            <div className="text-left space-y-1.5">
              ...
              <div className="relative group">
                <select
                  ...
                  className="w-full bg-[#FDFBF7] border border-[#D4AF37]/40 hover:border-[#D4AF37] text-stone-800 text-xs sm:text-sm font-semibold tracking-wide rounded-xl px-4 py-3.5 pr-10 appearance-none outline-none cursor-pointer transition-all duration-300 hover:shadow-[0_0_18px_rgba(212,175,55,0.25)] focus:border-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37]/20"
                >
